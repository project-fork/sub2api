  ...
  admin: {
    ...
    accounts: {
      ...
      bulkActions: {
        ...
        batchTest: 'Batch Test Connection',
        resetStatus: 'Reset Status',
        refreshToken: 'Refresh Token',
        resetStatusSuccess: 'Successfully reset {count} account(s) status',
        refreshTokenSuccess: 'Successfully refreshed {count} account(s) token',
        batchTestSuccess: 'Successfully tested connection for {count} account(s)',
        batchTestPartial: 'Connection test partially completed: {success} succeeded, {failed} failed',
